...
In this project, I studied variable aliasing while learning about Python object instantiation and object identifiers, types, and mutability. The project involved a series of quiz-like questions the answers to which I provided in single-line `.txt` files.
